...
respectivamente, como primer y segundo elementos de la misma, y sabiendo que cualquier elemento que se agregue 
...
function nFactorial(n) {
  if (n < 0) {
    return "no existe el factorial de: " + n;
  }
...
function nFibonacci(n) {
  if (n < 0) {
    return "no existe el n° fibonacci de: " + n;
  }
