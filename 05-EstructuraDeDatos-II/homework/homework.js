...
*/
function HashTable() { // * ejercicio adicional, debemos pasarle un parametro a HashTable: HashTable(number)
  this.numBuckets = 35; // * pasamos el parametro number: this.numBucket = number;
  this.buckets = [];
  ...
  HashTable.prototype.hash = function (key) {
    ...
    return accumulator % this.numBuckets;
  };
